...
## 概述
本文档描述了媒体如何通过 Client To Server（简称C2S）方式接入 铉音移动广告系统。本文档适用人群：媒体相关技术人员。<br/>
...
msg|是|string|响应提示
ads|否| <a href='#ad_model'>Ad</a> array fo object|广告内容

  <br/>  

#### <span id='ad_model'>**Ad object参数详解**</span>
key | 必返回 | 类型 | 描述 | 
---- | ----- | ---- |----
...
extend_tracking|是|<a href='#extendTracking_model'>ExtendTracking</a> array for object|其他扩展跟踪地址
